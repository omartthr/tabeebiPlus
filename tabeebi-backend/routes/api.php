...
// --- Rapor PDF Görüntüleme (Public — auth gerekmez) ---
Route::get('/reports/{identifier}', function ($identifier) {
    try {
        $appointment = null;
        ...
        return response('Rapor bulunamadı', 404);
    } catch (\Throwable $e) {
        return response('Hata: ' . $e->getMessage(), 500, ['Content-Type' => 'text/plain']);
    }
});

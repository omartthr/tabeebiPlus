...
export default function BookingScreen({ route, navigation }: Props) {
  ...
  const confirm = () => {
    navigation.navigate('Confirmed', {
      booking: { doctor, day: day.full, time: slot.t, payment },
    });
  };

  return (
    <SafeAreaView style={styles.screen}>
      <TopBar title="Book appointment" onBack={() => navigation.goBack()} />
      <ScrollView style={styles.scroll} contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        {/* Time slots */}
        <Text style={[styles.sectionLabel, { marginTop: 20 }]}>Available time</Text>
        ...
        <View style={styles.legend}>
          {[
            { color: colors.teal700, label: 'Selected', border: false },
            { color: colors.surface, label: 'Available', border: true },
            { color: colors.ink200, label: 'Unavailable', border: false },
          ].map(l => (
            <View key={l.label} style={styles.legendItem}>
              <View style={[
                styles.legendDot,
                { backgroundColor: l.color },
                l.border ? { borderWidth: 1.5, borderColor: colors.ink200 } : {},
              ]} />
        ...
        <View style={styles.paymentOptions}>
          {[
            ...
            },
            {
              ...
              Icon: Banknote,
              title: 'Pay at clinic',
              sub: 'Cash on arrival · pending confirm',
              badge: null,
            },
          ].map(opt => {
        ...
        <View style={styles.summary}>
          ...
          <View style={styles.summaryRow}>
            <Text style={styles.summaryKey}>Consultation</Text>
...
const styles = StyleSheet.create({
  ...
  doctorRecap: {
    ...
    borderWidth: 1, borderColor: colors.ink100, marginBottom: 8,
  },
  ...
  dayContent: { gap: 8 },
  dayBtn: {
    minWidth: 62, paddingVertical: 10, paddingHorizontal: 6, borderRadius: 14,
    backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.ink200,
  ...
  slotBtn: {
    width: '30%', paddingVertical: 12, borderRadius: 100,
    backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.ink200,
    alignItems: 'center',
  },
  ...
  radio: {
    ...
    borderWidth: 2, borderColor: colors.ink300,
    backgroundColor: colors.surface, alignItems: 'center', justifyContent: 'center',
  },
  radioActive: { backgroundColor: colors.teal700, borderColor: colors.teal700 },
  summary: {
    backgroundColor: colors.surface, borderRadius: 16, padding: 14,
    borderWidth: 1, borderColor: colors.ink100, gap: 10, marginTop: 8,
  },

...
export default function ConfirmedScreen({ route, navigation }: Props) {
  ...
  const goHome = () => (navigation as any).navigate('MainTabs', { screen: 'Home' });
  const goAppts = () => (navigation as any).navigate('MainTabs', { screen: 'Appointments' });
...
const styles = StyleSheet.create({
  ...
  checkCircle: { width: 96, height: 96, borderRadius: 48, backgroundColor: colors.teal700, alignItems: 'center', justifyContent: 'center', marginBottom: 24, shadowColor: '#1a7a73', shadowOffset: { width: 0, height: 16 }, shadowOpacity: 0.35, shadowRadius: 24, elevation: 10 },
  ...
  actions: { gap: 10 },
  btnPrimary: { height: 54, borderRadius: 100, backgroundColor: colors.teal700, alignItems: 'center', justifyContent: 'center', shadowColor: '#1a7a73', shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.25, shadowRadius: 10, elevation: 5 },
